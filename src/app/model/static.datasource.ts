...
export class StaticDataSource {
    private products: Product[] = [
        ...
        new Product(7, "Tricks of The Trade Shirt ", "Apparel", "Product 7 (Apparel 2)", 100),
        new Product(8, "Tricks of The Trade Iron on badge", "Apparel", "Product 8 (Apparel 2)", 100),
        new Product(9, "Tricks of The Trade Official Mech Shirt", "Apparel", "Product 9 (Apparel 2)", 100),
        new Product(10, "Extra Battery for Electric Ratchet", "Accessories", "Product 10 (Accessories)", 100),
        new Product(11, "Extra Charger For Electric Ratchet", "Accessories", "Product 11 (Accessories)", 100),
